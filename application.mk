...
INCLUDES += -I./demos/iot/ble/include
...
SRC_C += ./demos/iot/ble/iot_ble.c
SRC_C += ./demos/iot/ble/iot_ble_service.c
...
CUR_PATH = $(shell pwd)
.PHONY: application
application: $(OBJ_LIST) $(OBJ_S_LIST) $(OBJ_OS_LIST) $(WPA_LIB) $(RWNX_LIB) $(USB_LIB) $(SENSOR_LIB)  $(BLE_LIB)
...
.PHONY: cleanlib
cleanlib:
	$(Q)-rm -rf $(RWNX_LIB) $(WPA_LIB) $(USB_LIB) $(BLE_LIB) $(SENSOR_LIB)
	@$(ECHO) "$(GREEN)Done$(NC)"
