...
{
	SCAN_IDX_SVC,
	SCAN_IDX_FF01_VAL_CHAR,
	SCAN_IDX_FF01_VAL_VALUE,
	SCAN_IDX_FF02_VAL_CHAR,
	SCAN_IDX_FF02_VAL_VALUE,
	SCAN_IDX_FF02_VAL_IND_CFG,
	SCAN_IDX_FF03_VAL_CHAR,
	SCAN_IDX_FF03_VAL_VALUE,

    SCAN_IDX_FF04_VAL_CHAR,
	SCAN_IDX_FF04_VAL_VALUE,
    SCAN_IDX_FF05_VAL_CHAR,
	SCAN_IDX_FF05_VAL_VALUE,
    SCAN_IDX_FF05_VAL_IND_CFG,
    SCAN_IDX_FF06_VAL_CHAR,
	SCAN_IDX_FF06_VAL_VALUE,
    SCAN_IDX_FF07_VAL_CHAR,
	SCAN_IDX_FF07_VAL_VALUE,
...
bk_attm_desc_t connect_att_db[SCAN_IDX_NB] =
{
	//  Service Declaration
	[SCAN_IDX_SVC]              = {BK_ATT_DECL_PRIMARY_SERVICE_128, BK_PERM_SET(RD, ENABLE), 0, 0},

	//  Level Characteristic Declaration
	[SCAN_IDX_FF01_VAL_CHAR]    = {BK_ATT_DECL_CHARACTERISTIC_128,  BK_PERM_SET(RD, ENABLE), 0, 0},
	//  Level Characteristic Value
	[SCAN_IDX_FF01_VAL_VALUE]   = {VERSION_CHARACTERISTIC_128,      BK_PERM_SET(NTF, ENABLE)|BK_PERM_SET(RD, ENABLE), BK_PERM_SET(RI, ENABLE)|BK_PERM_SET(UUID_LEN, UUID_32), 128},

	[SCAN_IDX_FF02_VAL_CHAR]    = {BK_ATT_DECL_CHARACTERISTIC_128,  BK_PERM_SET(RD, ENABLE), 0, 0},
	//  Level Characteristic Value
	[SCAN_IDX_FF02_VAL_VALUE]   = {SCAN_CHARACTERISTIC_128,         BK_PERM_SET(NTF, ENABLE)|BK_PERM_SET(RD, ENABLE)|BK_PERM_SET(WRITE_REQ, ENABLE), BK_PERM_SET(RI, ENABLE)|BK_PERM_SET(UUID_LEN, UUID_32), 128},
	// //  Level Characteristic - Client Characteristic Configuration Descriptor
    [SCAN_IDX_FF02_VAL_IND_CFG] = {BK_ATT_DESC_CLIENT_CHAR_CFG_128, BK_PERM_SET(RD, ENABLE)|BK_PERM_SET(WRITE_REQ, ENABLE), 0, 0},


    [SCAN_IDX_FF03_VAL_CHAR]    = {BK_ATT_DECL_CHARACTERISTIC_128,  BK_PERM_SET(RD, ENABLE), 0, 0},
	//  Level Characteristic Value
	[SCAN_IDX_FF03_VAL_VALUE]   = {SCANRESULT_CHARACTERISTIC_128,   BK_PERM_SET(WRITE_REQ, ENABLE)|BK_PERM_SET(WRITE_COMMAND, ENABLE), BK_PERM_SET(RI, ENABLE)|BK_PERM_SET(UUID_LEN, UUID_32), 128},

    [SCAN_IDX_FF04_VAL_CHAR]    = {BK_ATT_DECL_CHARACTERISTIC_128,  BK_PERM_SET(RD, ENABLE), 0, 0},
	[SCAN_IDX_FF04_VAL_VALUE]   = {CONNECT_CHARACTERISTIC_128,      BK_PERM_SET(WRITE_REQ, ENABLE)|BK_PERM_SET(WRITE_COMMAND, ENABLE), BK_PERM_SET(RI, ENABLE)|BK_PERM_SET(UUID_LEN, UUID_32), 300},

	[SCAN_IDX_FF05_VAL_CHAR]    = {BK_ATT_DECL_CHARACTERISTIC_128,  BK_PERM_SET(RD, ENABLE), 0, 0},
	[SCAN_IDX_FF05_VAL_VALUE]   = {STATUS_CHARACTERISTIC_128,       BK_PERM_SET(NTF, ENABLE)|BK_PERM_SET(RD, ENABLE), BK_PERM_SET(RI, ENABLE)|BK_PERM_SET(UUID_LEN, UUID_32), 128},
    [SCAN_IDX_FF05_VAL_IND_CFG] = {BK_ATT_DESC_CLIENT_CHAR_CFG_128, BK_PERM_SET(RD, ENABLE)|BK_PERM_SET(WRITE_REQ, ENABLE), 0, 0},

    [SCAN_IDX_FF06_VAL_CHAR]    = {BK_ATT_DECL_CHARACTERISTIC_128,  BK_PERM_SET(RD, ENABLE), 0, 0},
	[SCAN_IDX_FF06_VAL_VALUE]   = {WIFI_CONFIG_USER_ID,             BK_PERM_SET(WRITE_REQ, ENABLE)|BK_PERM_SET(WRITE_COMMAND, ENABLE), BK_PERM_SET(RI, ENABLE)|BK_PERM_SET(UUID_LEN, UUID_32), 20},

    [SCAN_IDX_FF07_VAL_CHAR]    = {BK_ATT_DECL_CHARACTERISTIC_128,  BK_PERM_SET(RD, ENABLE), 0, 0},
	[SCAN_IDX_FF07_VAL_VALUE]   = {WIFI_CONFIG_API_INFO,            BK_PERM_SET(WRITE_REQ, ENABLE)|BK_PERM_SET(WRITE_COMMAND, ENABLE), BK_PERM_SET(RI, ENABLE)|BK_PERM_SET(UUID_LEN, UUID_32), 300},
};
...
ble_err_t bk_ble_init(void)
{
    ...
    struct bk_ble_db_cfg ble_db_cfg[2];

    ble_db_cfg[0].att_db = test_att_db;
    ble_db_cfg[0].att_db_nb = TEST_IDX_NB;
    ble_db_cfg[0].prf_task_id = 0;
    ble_db_cfg[0].start_hdl = 0;
    ble_db_cfg[0].svc_perm = BK_PERM_SET(SVC_UUID_LEN, UUID_16);
    memcpy(&(ble_db_cfg[0].uuid[0]), &test_svc_uuid[0], 16);

    ble_db_cfg[1].att_db = connect_att_db;
    ble_db_cfg[1].att_db_nb = SCAN_IDX_NB;
    ble_db_cfg[1].prf_task_id = 1;
    ble_db_cfg[1].start_hdl = 0;
    ble_db_cfg[1].svc_perm = BK_PERM_SET(SVC_UUID_LEN, UUID_32);
    memcpy(&(ble_db_cfg[1].uuid[0]), &scan_svc_uuid[0], 16);

    status = bk_ble_create_db(&ble_db_cfg[0]);
    vTaskDelay(100);
    status = bk_ble_create_db(&ble_db_cfg[1]);
    vTaskDelay(100);
    return status;
}
